#!/usr/bin/python2
#coding=utf-8
#This Script Is Written By QURBAN YOUSAFZAI
  #=================================#
  #Qurban-yousafzai The Official Programmrer#   
  #                                 #
  #                                 #
  #=================================#
...
\033[1;95m╔═━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⌗⊰
\033[1;92m║\033[1;93mAUTHOR ⊱⟡⊰ \033[1;92mQurban Yousafzai     
\033[1;92m║\033[1;93mCREATE BY ⊱⟡⊰ \033[1;92mQurban Yousafzai
\033[1;92m║\033[1;93mFACEBOOK ⊱⟡⊰ \033[1;92mhttps://www.facebook.com/profile.php?id=100009609031459          
\033[1;95m╚═━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⌗⊰                        
...
\033[1;92m CHECKPPINT ACCOUNT OPEN AFTER 4 DAYS ✔️
\033[1;93m LIKE MY CHANNEL✔️
\033[0;33m⚚═╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌═⚚
...
jalan('\033[1;31m⋕⋕ QURBAN YOUSAFZAI ⋕⋕') 
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;32mLOADING..... " + username #Dev:QURBAN-YOUSAFZAI
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:QURBAN-YOUSAFZAI
	print logo
...
def pilih_super():
	...
	print """
\033[0;33m⚚═╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌═⚚
\033[1;32m⚚═╌╌╌ CHECKPOINT ACCOUNT OPEN AFTER 4 DAYS╌╌╌═⚚
"""
...
To learn ethical hacking stay connected with my Channel
 """
